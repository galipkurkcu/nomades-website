...
function initAgentPopup() {
  ...
  function openPopup(id) {
    ...
    galleryEl.innerHTML = GALLERY_TYPES.map(type => {
      ...
      const src = `images/carousel/${carouselFolder}-${type}.webp`;
...
const TRANSLATIONS = {
  en: {
    ...
    'svc.01.num':        '01',
    'svc.01.title':      'Instagram DM, Comment & Story Automation',
    'svc.01.desc':       'Signal Intelligence',
    ...
    'svc.02.num':        '02',
    'svc.02.title':      'In-House CRM & Brand Automation',
    'svc.02.desc':       'Orbital Intelligence',
    ...
    'svc.03.num':        '03',
    'svc.03.title':      'Social Media Management',
    'svc.03.desc':       'Signal Broadcasting',
    ...
    'proc.02.desc':  "31 in-depth questions extract your brand's DNA before we build anything. Goals, voice, audience, pain points - every answer feeds directly into the system.",
  ...
  tr: {
    ...
    'svc.01.num':       '01',
    'svc.01.title':     'Instagram DM, Yorum ve Story Otomasyonu',
    'svc.01.desc':      'İletişim Zekası',
    ...
    'svc.02.num':       '02',
    'svc.02.title':     'Inhouse CRM ve Markaya Özel Otomasyon',
    'svc.02.desc':      'Çevresel Zeka',
    ...
    'svc.03.num':       '03',
    'svc.03.title':     'Sosyal Medya Yönetimi',
    'svc.03.desc':      'Sinyal Yayını',
    ...
    'proc.02.desc':  '31 derinlemesine soru, herhangi bir şey inşa etmeden önce markanızın DNA\'sını çıkarır. Hedefler, ses tonu, kitle, acı noktaları - her cevap doğrudan sistemi besler.',
